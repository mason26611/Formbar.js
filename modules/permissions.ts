...
const MANAGER_PERMISSIONS = 5 as const;
const TEACHER_PERMISSIONS = 4 as const;
const MOD_PERMISSIONS = 3 as const;
const STUDENT_PERMISSIONS = 2 as const;
const GUEST_PERMISSIONS = 1 as const;
const BANNED_PERMISSIONS = 0 as const;
...
const DEFAULT_CLASS_PERMISSIONS: Record<string, number> = {
    links: MOD_PERMISSIONS,
    controlPoll: MOD_PERMISSIONS,
    manageStudents: TEACHER_PERMISSIONS,
    breakHelp: MOD_PERMISSIONS,
    manageClass: TEACHER_PERMISSIONS,
    auxiliary: MOD_PERMISSIONS,
    userDefaults: GUEST_PERMISSIONS,
    seePoll: GUEST_PERMISSIONS,
    votePoll: STUDENT_PERMISSIONS,
};

// This defines global socket permissions that define who can use each socket event
const GLOBAL_SOCKET_PERMISSIONS: Record<string, number> = {
...
const CLASS_SOCKET_PERMISSIONS: Record<string, number> = {
...
const CLASS_SOCKET_PERMISSION_MAPPER: Record<string, string> = {
...
const SOCKET_EVENT_SCOPE_MAP: Record<string, string | null> = {
