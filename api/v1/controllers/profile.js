...
module.exports = (router) => {
    ...
    router.get("/profile/:userId?", isAuthenticated, isVerified, permCheck, async (req, res) => {
        ...
        const emailVisible = req.user.id === id || classStateStore.getUser(req.user.email)?.permissions >= MANAGER_PERMISSIONS;
        ...
        res.status(200).json({
            ...
            data: {
                ...
                pogMeter: classStateStore.getUser(email) ? classStateStore.getUser(email).pogMeter : 0,
